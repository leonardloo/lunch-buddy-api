...
@Api(name = "requestendpoint", namespace = @ApiNamespace(ownerDomain = "lunchbuddy.com", ownerName = "lunchbuddy.com", packagePath = "models"))
public class RequestEndpoint {
	...
	public Request getRequest(@Named("id") Long id) {
		...
		try {
			request = mgr.getObjectById(Request.class, id);
		} finally {
			mgr.close();
		}
		return request;
	...
	public void removeRequest(@Named("id") Long id) {
		PersistenceManager mgr = getPersistenceManager();
		try {
			Request request = mgr.getObjectById(Request.class, id);
			mgr.deletePersistent(request);
		} finally {
			mgr.close();
		}
	}
	...
	private boolean containsRequest(Request request) {
		...
		try {
			mgr.getObjectById(Request.class, request.getKey());
