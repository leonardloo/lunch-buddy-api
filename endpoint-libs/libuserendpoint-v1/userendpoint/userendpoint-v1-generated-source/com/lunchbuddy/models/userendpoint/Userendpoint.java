...
package com.lunchbuddy.models.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.lunchbuddy.models.userendpoint.model.LunchUser> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.lunchbuddy.models.userendpoint.model.LunchUser.class);
   ...
   *
   * @param content the {@link com.lunchbuddy.models.userendpoint.model.LunchUser}
   * @return the request
   */
  public InsertUser insertUser(com.lunchbuddy.models.userendpoint.model.LunchUser content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.lunchbuddy.models.userendpoint.model.LunchUser> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.lunchbuddy.models.userendpoint.model.LunchUser content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.lunchbuddy.models.userendpoint.model.LunchUser.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.lunchbuddy.models.userendpoint.model.CollectionResponseLunchUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.lunchbuddy.models.userendpoint.model.CollectionResponseLunchUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.lunchbuddy.models.userendpoint.model.LunchUser content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.lunchbuddy.models.userendpoint.model.LunchUser> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.lunchbuddy.models.userendpoint.model.LunchUser content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.lunchbuddy.models.userendpoint.model.LunchUser.class);
    }
